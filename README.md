# DPI Warrior - Linux MIPS32 LE

**DPI Warrior Edition** - Xray v25.6.8 Native Build for Linux MIPS32 LE

## 📋 Branch Information
- **Branch**: `linux-mips32le`
- **Platform**: Linux
...
```bash
git clone -b linux-mips32le https://github.com/yoseidonn/dpi-warrior-native-xray-binaries.git
```

### Download as ZIP
1. Go to: https://github.com/yoseidonn/dpi-warrior-native-xray-binaries
2. Click on branch dropdown
3. Select: `linux-mips32le`
4. Click "Code" → "Download ZIP"

## 📁 Contents

Native binary for MIPS32 Little Endian Linux systems
