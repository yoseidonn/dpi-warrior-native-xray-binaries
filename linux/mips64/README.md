# DPI Warrior - Linux MIPS64

**DPI Warrior Edition** - Xray v25.6.8 Native Build for Linux MIPS64
...
```bash
git clone -b linux-mips64 https://github.com/yoseidonn/dpi-warrior-native-xray-binaries.git
```

### Download as ZIP
1. Go to: https://github.com/yoseidonn/dpi-warrior-native-xray-binaries
2. Click on branch dropdown
3. Select: `linux-mips64`
4. Click "Code" → "Download ZIP"

## 📁 Contents

Native binary for MIPS64 Linux systems
